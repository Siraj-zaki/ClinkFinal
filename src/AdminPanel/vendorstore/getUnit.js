...
class GetUnit extends React.Component {
    ...
    async componentDidMount(){
        ...
        let customer = await api.getUnit()
        console.log(customer);
        this.setState({unitdata:customer.result})
    }
    
    
    deleteHandler = async () => {
        let res = await api.deleteunit( this.state.deleteID)
        if (res) {
...
export default connect(mapState, mapDispatch)(GetUnit)